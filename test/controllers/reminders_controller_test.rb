...
class RemindersControllerTest < ActionController::TestCase
  ...
  test "should create reminder" do
    assert_difference('Reminder.count') do
      post :create, reminder: { email: @reminder.email, phrase: @reminder.phrase, service: @reminder.service, user_id: @reminder.user_id }
    end
  ...
  test "should update reminder" do
    patch :update, id: @reminder, reminder: { email: @reminder.email, phrase: @reminder.phrase, service: @reminder.service, user_id: @reminder.user_id }
    assert_redirected_to reminder_path(assigns(:reminder))
  end
