...
ActiveRecord::Schema.define(version: 2018_10_11_143702) do
  ...
  create_table "diary_entries", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.timestamp "date"
  ...
  create_table "okaapis", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "subject"
    t.text "content"
    t.timestamp "time"
    t.string "from"
